...
# # TODO: Off-load this to litellm implementation
# class GPT:
#     def __init__():
#         pass
...
#     def forward(self, image, priorities=None, detail="high"):
#         # Gets the call arguments to GPT4 based on the inputs
#         messages = (self.get_message(image, priorities, detail=detail) 
#                     if priorities 
#                     else self.get_standard_message(image, detail=detail))
        
#         # Runs the visual critique component
#         vis_resp_json = client.chat.completions.create(
#             model="gpt-4-vision-preview",
#             messages=messages
#         )
#         vision_response = vis_resp_json['choices'][0]['message']['content']
        
#         # Formats it to JSON
#         json_response = self.response_to_json(vision_response)
        
#         # TODO: output as JSON mapping priority with text
#         # TODO: Look into validating the output
#         # TODO: Go into writing with DSPY
